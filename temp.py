...
# st
# test
# case, X = 6, N = 4 and p1 = {7, 3, 3, 5}.The
# chocolates
# can
# be
# divided
...
# nd
# test
# case, X = 6, N = 4 and p2 = {2, 3, 4, 1}.The
# chocolates
# can
# 't be divided into pairs.
#
...
# => b+d is a multiple of X
#
# What happens if a+b is also a multiple of X?
#
# X = 6
# 7 3 3 5 2 4
# [7,5][3,3][2,4]
